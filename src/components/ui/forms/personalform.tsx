...
import  { regitser } from "../../../app/action/register"
            ...
            className='mt-6 w-[100%]'>
                        ...
                        <form onSubmit={form.handleSubmit(handleRegister)}>
                                ...
                                <FormItem>
                                    ...
                                    <FormControl>
                                        ...
                                        disabled={loading}
                                         ...
                                         {...field} placeholder='Enter Your DateOf Birth' className='bg-[#121212] text-[#FFF] w-full'/>
                                    </FormControl>
                            ...
                            render={({field})=>
                                <FormItem>
                                    <div className='flex items-center justify-between w-full mb-2'>
                                    <FormLabel>जारी मिति (mm/dd/yyyy)*:</FormLabel>
                                    <FormMessage className='flex justify-start'/>
                                    </div>
                                    
                                    <FormControl>
                                        <Input disabled={loading} type='date' {...field} placeholder="Enter Date" className='bg-[#121212] text-[#FFF] w-full'/>
                                    </FormControl>
                            ...
                            render={({field})=>
                                <FormItem>
                                    ...
                                    <FormControl>
                                      <SelectTrigger>
                                        <SelectValue placeholder="Select Your CitizenShip Type"/>
                           ...
                           <div className='flex gap-4'>
                            ...
                            render={({field})=>
                                <FormItem>
                                    ...
                                    <FormControl>
                                      <SelectTrigger>
                                        <SelectValue placeholder="Select Your Proffession"/>
                            ...
                            render={({field})=>
                                <FormItem>
                                   <div className='flex items-center justify-between w-full mb-2'>
                                    ...
                                    <FormControl>
                                        <Input  type='date'   disabled={loading} {...field} placeholder='Enter Date' className='bg-[#121212] text-[#FFF]'/>
                                    </FormControl>
